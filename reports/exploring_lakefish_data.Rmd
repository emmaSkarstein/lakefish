...
From these plots we see that a large portion of the observations were done between 1990 and 2000, which is expected after looking at \@ref(fig:years_barplot) with the large spike in 1993. There also seems to be a pattern with a large area in the middle of southern Norway having close to no observations in this time period. This area does however seem to have the majority of the observations in the next time period. This could indicate that some type of organized survey or observation effort was done in this time period, perhaps to fill this geographic hole in the data.
