...
<<<<<<< HEAD
=======
# register_google(key = "AIzaSyCOMdnUfognLZhDCS1Mhg6gatOaHXgYRKU")
# map.fennoscandia <- get_map("Sweden", zoom = 4)
# ggmap(map.fennoscandia) 
...
ggplot() + geom_map(data = norway, map = norway, aes(long, lat, map_id=region), color="#2b2b2b", fill=NA) + geom_point(aes(x = occ_matched$decimalLongitude, y = occ_matched$decimalLatitude), size=0.01)

# Can we even use ggmap to plot this?
# I think maybe we should look for alternate mapping system.
