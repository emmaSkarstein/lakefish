...
```{r}
# Rmarkdown ser ut til å ha problemer med å lokalisere datafilene som ligger i en annen mappe enn selve mappa der rapporten ligger, så jeg legger inn de to data-filene vi trenger der
...
In the animations above we got a sense of the observations over time, but the constant movement of the animation makes it a bit difficult to absorb. Here we have divided all the observations from 1970 to 2010 into four sections: 1970 - 1979, 1980 - 1989, 1990 - 1999 and 2000 - 2010, and we plot all species for each time period.

```{r}
# OBS: some updates needed here, excluding the 10-years
...
Next plots:
- Look at species richness per lake 
- Would it be interesting to zoom in somewhere?
